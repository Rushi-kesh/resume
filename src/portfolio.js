...
const skillsSection = {
  ...
  skills: [
    emoji("⚡ Develop production ready applications with hight scalabiltiy and various features"),
    emoji("⚡ AI/ML application with various tech stacks"),
    emoji("⚡ SAML SSO with php frameworks"),
    emoji("⚡ Integration of cloud services such as AWS / GCP"),
    emoji("⚡ React native app development")
  ],
...
const techStack = {
  ...
  experience: [
    ...
    {
      Stack: "MySQL/MongoDB",  //Insert stack or technology you have experience in
  ...
  experience: [
    {
      ...
      desc: "Working on real-time product which uses MERN stack.",
      descBullets: [
        "Implemented Saml SSO with PHP(Lumen) framework",
        "Worked on Conversation,Associated-Persons,IMS modules Migration Scripts"
      ]
    },
    {
      ...
      desc: "Successfully Completed Organic Bots Incubator program with specialization in Robotics, Machine Learning and Blockchain Technologies"
    },
    {
      ...
      desc: "Developed a basic html/css responsive site for hotel nisarg"
    },
  ]
};
